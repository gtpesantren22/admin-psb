...
class Export extends CI_Controller
{
	...
	public function baruXLS()
	{
		...
		foreach ($siswa as $data) { // Lakukan looping pada variabel siswa
			...
			$sheet->getStyle('D' . $numrow)->getNumberFormat()->setFormatCode('0000000000000000');
			$sheet->getCell('E' . $numrow)->setValue($data->no_kk);
			$sheet->getStyle('E' . $numrow)->getNumberFormat()->setFormatCode('0000000000000000');
			$sheet->getCell('W' . $numrow)->setValue($data->a_nik);
			$sheet->getStyle('W' . $numrow)->getNumberFormat()->setFormatCode('0000000000000000');
			$sheet->getCell('AG' . $numrow)->setValue($data->i_nik);
			$sheet->getStyle('AG' . $numrow)->getNumberFormat()->setFormatCode('0000000000000000');
