...
<head>
    ...
    <!-- Select2 -->
    <link href="bunda/vendor/select2/dist/css/select2.min.css" rel="stylesheet" type="text/css">
    <link href="bunda/css/ruang-admin.min.css" rel="stylesheet">
    <link href="bunda/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body class="bg-gradient-primary">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="" method="post">
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <input type="hidden" name="hp" value="<?= $r['no_hp']; ?>">
    ...
    <!-- Select2 -->
    <script src="bunda/vendor/select2/dist/js/select2.full.min.js"></script>
    <script src="bunda/vendor/select2/dist/js/select2.min.js"></script>
    <script src="bunda/vendor/chart.js/Chart.min.js"></script>
    <script src="bunda/js/demo/chart-area-demo.js"></script>
    <script src="bunda/js/ruang-admin.min.js"></script>
    <!-- Datatables -->
    <script src="bunda/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="bunda/vendor/datatables/dataTables.bootstrap4.min.js"></script>
...
if (isset($_POST['save'])) {
    ...
    $username = htmlspecialchars(strtolower(mysqli_real_escape_string($conn, $_POST['username'])));
    ...
    $passOk = password_hash($password, PASSWORD_DEFAULT);
  ...
  *Terimakasih*
  ...
  silahkan bisa di gunakan di https://admin-psb.ppdwk.com .

  by : @admin DWK 2022
  ';

    $sql1 = mysqli_query($conn, "UPDATE user SET username = '$username', password = '$passOk', level = '$level', aktif = '$aktif' WHERE id_user = '$id_user' ");

    if ($sql1) {
        echo "
                <script>
                alert('Akun sudah diaktifkan');
                window.location = 'sktiv.php';
                </script>
                ";
