...
class SantriDv extends CI_Controller
{
	function __construct()
	{
		...
		if (!$this->Auth_model->current_user() || $user->level != 'admin' && $user->level != 'division') {
	...
	public function index()
	{
		...
		$this->load->view('bidang/baru', $data);
	...
	public function lanjut()
	{
		...
		$this->load->view('bidang/head', $data);
		$this->load->view('bidang/lama', $data);
		$this->load->view('bidang/foot');
	}
