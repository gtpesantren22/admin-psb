...
$dt = mysqli_query($conn, "SELECT a.*, b.nama, b.desa, b.kec, b.kab, b.lembaga, b.nik, SUM(nominal) AS bayar FROM regist a JOIN tb_santri b ON a.nis=b.nis WHERE b.ket = 'baru' GROUP BY a.nis ORDER BY `b`.`nama` ASC ");
