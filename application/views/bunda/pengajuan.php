                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Total Pengeluaran Pengajuan</div>
                        ...
                        <div class="d-flex mb-2">
                            <div>jumlah pengeluaran pengajuan</div>
                            <div class="ms-auto">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="h1 mb-3"><?= rupiah($keluarAll->total) ?></div>
                        <div class="d-flex mb-2">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="h1 mb-3"><?= rupiah($keluarAll->total + $totalKeluar->total) ?></div>
                        <div class="d-flex mb-2">
                            <div>jumlah pengeluaran total</div>
                            <div class="ms-auto">
                                <span class="text-green d-inline-flex align-items-center lh-1">
                                    %
                                    <!-- Download SVG icon from http://tabler-icons.io/i/trending-up -->
