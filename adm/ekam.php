                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                        ...
                                        <li>
                                            ...
                                            <div class="message_wrapper">
                                                ...
                                                <blockquote class="message">
                                                    <?= $almt['kl'] . ' - ' . $almt['kc'] . ' - ' . $almt['kb'] . ' - ' . $almt['pr'] ?>
                                                </blockquote>
                                    ...
                                    <form action="" method="post">
                                            ...
                                            <table class="table table-striped jambo_table ">
                                                ...
                                                <tbody>
                                                    <tr class="even pointer">
                                                        <td> Komplek</td>
                                                        <td><select class="form-control" name="komplek" id="komplek"
                                                                required>
                                                    ...
                                                    <tr class="even pointer">
                                                        <td>Pillih Kamar</td>
                                                        <td><select class="form-control" name="kamar" id="kamar"
                                                                required>
                                                    ...
                                                    <tr class="even pointer">
                                                        ...
                                                        <td><select class="form-control" name="loker" id="loker"
                                                                required>
                                        ...
                                        <button type="submit" name="save" class="btn btn-success pull-right"><i
