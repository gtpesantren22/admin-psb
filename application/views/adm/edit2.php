                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active show" id="diri">
                                        <form action="<?= base_url('santriAdm/saveIdentitas2'); ?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="tab-pane" id="mahrom">
                                        <h4>Data Ayah</h4>
                                        <form action="<?= base_url('santriAdm/saveMahrom2'); ?>" method="post" class="form-horizontal">
                                            <div class="row">
                                                <input type="hidden" name="id" value="<?= $data->id_santri ?>">
                                                <div class="col-md-6">
                                                    <div class="mb-3 row">
                                    ...
                                    <div class="tab-pane" id="alamat">
                                        <h4>Alamat</h4>
                                        <form action="<?= base_url('santriAdm/saveAddres2'); ?>" method="post" class="form-horizontal">
                                            <input type="hidden" name="id" value="<?= $data->id_santri ?>">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3 row">
                                    ...
                                    <div class="tab-pane" id="pendidikan">
                                        <h4>Pendidikan</h4>
                                        <form action="<?= base_url('santriAdm/saveUniv2'); ?>" method="post" class="form-horizontal">
                                            <input type="hidden" name="id" value="<?= $data->id_santri ?>">
                                            <div class="col-md-12">
                                                <div class="mb-3 row">
                                    ...
                                    <div class="tab-pane" id="lain">
                                        <h4>lain tab</h4>
                                        <form action="<?= base_url('santriAdm/saveOther2'); ?>" method="post" class="form-horizontal">
                                            <input type="hidden" name="id" value="<?= $data->id_santri ?>">
                                            <div class="col-md-12">
                                                <div class="mb-3 row">
