        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <?php if ($data->status == 'proses') : ?>
                    <div class="btn-list">
                        <a href="<?= base_url('bidang/verval/' . $data->kode_pengajuan) ?>" class="btn btn-success d-none d-sm-inline-block tbl-confirm" value="Pengajuan akan diverifikasi/disetujui">
...
<div class="modal fade" id="addBaruPengajuan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('bidang/pengajuanTolak'); ?>
