                        ...
                        <div class="row row-cards">
                            <div class="col-sm-6 col-lg-3">
                                <div class="card card-sm">
                                    ...
                                    <a href="#" class="d-block"><img src="<?= 'https://psb.ppdwk.com/assets/berkas/' . $data->diri ?>" class="card-img-top"></a>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="card card-sm">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card card-sm">
                                    ...
                                    <a href="#" class="d-block"><img src="<?= 'https://psb.ppdwk.com/assets/berkas/' . $foto->ayah ?>" class="card-img-top"></a>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="card card-sm">
                                    ...
                                    <a href="#" class="d-block"><img src="<?= 'https://psb.ppdwk.com/assets/berkas/' . $foto->ibu ?>" class="card-img-top"></a>
                                </div>
                            </div>
                        </div>
                    </div>
