                                            ...
                                            <td>
                                                <!-- <div class="btn-group btn-sm btn-success" role="group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?= base_url('santriAdm/edit/' . $row->nis); ?>">Edit</a>
                                                ...
                                                <a class="btn btn-warning btn-sm" href="<?= base_url('santriAdm/cek/' . $row->nis); ?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                ...
                                                <!-- <a class="btn btn-danger btn-sm" href="<?= base_url('santriAdm/sendGp/' . $row->nis); ?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
