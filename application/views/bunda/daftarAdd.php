                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                ...
                                                <input type="hidden" name="id_bayar" class="form-control"
                                                    aria-describedby="emailHelp" value="<?= $bp->id_bayar; ?>" readonly>
                                            </div>
                                            <br>
                                            ...
                                            <div>
                                                <input type="text" name="tangg" class="form-control"
                                                    aria-describedby="emailHelp"
                                                    value="<?= rupiah(gel($santri->gel)); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <input type="text" name="kasir" class="form-control" id=""
                                                    placeholder="Tanggal Bayar" readonly value="<?= $user->nama; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
