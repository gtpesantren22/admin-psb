...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Biaya Registratsi Santri Lama</h1>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Pembayaran Registrasi Santri Lama</h6>
                    ...
                    <a href="ex_regblm.php" target="_blank" class="btn btn-success float-right"><i class="fa fa-download"></i> Export to Excel</a>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <table class="table align-items-center table-flush table-hover table-sm" id="dataTableHover2">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            // $lm = array("", "MTs", "SMP", "MA", "SMK");
                            $sql1 = mysqli_query($conn, "SELECT * FROM tb_santri WHERE NOT EXISTS (SELECT * FROM tanggungan WHERE tanggungan.nis=tb_santri.nis) AND ket = 'lama' ");
