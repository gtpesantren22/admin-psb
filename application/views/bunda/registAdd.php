                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?= base_url('daftar/kirim/') . $row->id_regist ?>" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-send" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none">
                                                                        </path>
                                                            ...
                                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <label class="form-label required">Tanggal Bayar</label>
                                                                        <div>
                                                                            <input type="text" name="tgl_bayar" class="form-control" id="datepicker2" placeholder="Tanggal Bayar" value="<?= $row->tgl_bayar ?>" required>
                                                                        </div>
                                                                        <br>
                                                                        <label class="form-label required">Via</label>
                                                                        <div>
