                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title">
                                            ...
                                            <a href="<?= base_url('regist/tgnEdit/' . $santri->nis) ?>"
                                            ...
                                            <button class="btn btn-warning ms-auto" type="button" data-bs-toggle="modal"
                                                data-bs-target="#modal-large"><svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-file-pencil" width="24"
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="text-muted">
                                                    <?= rupiah(($tgn->infaq + $tgn->buku + $tgn->kartu + $tgn->kalender + $tgn->seragam_pes + $tgn->seragam_lem + $tgn->orsaba) - $byr->row('nominal')) ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap table-sm"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('regist/del/') . $row->id_regist ?>"
                                                            ...
                                                            <button type="button" data-bs-toggle="modal"
                                                                data-bs-target="#modal-large<?= $row->id_regist ?>"
                                                            ...
                                                            <a href="<?= base_url('daftar/kirim/') . $row->id_regist ?>"
                                                    ...
                                                    <div class="modal modal-blur fade"
                                                        id="modal-large<?= $row->id_regist ?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-lg modal-dialog-centered"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <input type="hidden" name="nis"
                                                                    value="<?= $santri->nis; ?>">
                                                                <input type="hidden" name="id_regist"
                                                                    value="<?= $row->id_regist; ?>">
                                                                    ...
                                                                    <div>
                                                                        <label class="form-check">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="via" value="Cash"
                                                                                <?= $row->via === 'Cash' ? 'checked' : '' ?>>
                                                                            <span class="form-check-label">Cash</span>
                                                                        </label>
                                                                        <label class="form-check">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="via" value="Transfer"
                                                                                <?= $row->via === 'Transfer' ? 'checked' : '' ?>>
                                                                            <span
                                                                                class="form-check-label">Transfer</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm">
                        <tr>
                            <th>1</th>
                            <th>Seragam Pesantren</th>
                            <th><input type="text" name="seragam_pes" class="form-control uang"
                                    value="<?= $tgn->seragam_pes ?>" required>
                            </th>
                        </tr>
                        <tr>
                            <th>2</th>
                            <th>Seragam Lembaga (Khas dan Kaos Olahraga)</th>
                            <th><input type="text" name="seragam_lem" class="form-control uang"
                                    value="<?= $tgn->seragam_lem ?>" required></th>
                        </tr>
                        <tr>
                            <th>3</th>
                            <th>ORSABA</th>
                            <th><input type="text" name="orsaba" class="form-control uang" value="<?= $tgn->orsaba ?>"
                                    required></th>
                        </tr>
                        <tr>
                            <th>4</th>
                            <th>KTS, Kartu Mahrom, Kartu Kesehatan, dan Foto</th>
                            <th><input type="text" name="kartu" class="form-control uang" value="<?= $tgn->kartu ?>"
                                    required></th>
                        </tr>
                        <tr>
                            <th>5</th>
                            <th>Buku Pedoman Wiridan, Perizinan & Tatib</th>
                            <th><input type="text" name="buku" class="form-control uang" value="<?= $tgn->buku ?>"
                                    required></th>
                        </tr>
                        <tr>
                            <th>6</th>
                            <th>Kalender Pesantren</th>
                            <th><input type="text" name="kalender" class="form-control uang"
                                    value="<?= $tgn->kalender ?>" required></th>
                        </tr>
                        <tr>
                            <th>7</th>
                            <th>Uang Gedung</th>
                            <th><input type="text" name="infaq" class="form-control uang" value="<?= $tgn->infaq ?>"
                                    required></th>
                        </tr>
