        ...
        <div class="col-lg-12">
            <div class="panel-body">
                <table width="100%" border="0">
                    <tr>
                        <td rowspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td rowspan="3" style="text-align: center;"><img src="img/lg1.png" width=" 130" height="98">
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="8"> : <?= $data['tempat']; ?>, <?= tgl($data['tanggal']); ?></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>Alamat </td>
                    ...
                    <tr>
                        <td colspan="2"><b><u><?= $pn['nama']; ?></u></b></td>
                        <td colspan="4"></td>
